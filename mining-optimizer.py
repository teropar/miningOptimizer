...
# No admin needed for:
 ...
 LTC: MVqT5iMZTDnidn7YGnQzcWcbupv4T3yYju
"""
...
#currently check is done only for the first GPU! <- TODO
perf_levels = 4 
...
#check that the requested power limits are both higher than the real GPU minimum
